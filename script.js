...
// Buttons Desktop
const personalInfoNext = document.querySelector(".personal-info-next");
const selectPlanPrevious = document.querySelector(".select-plan-previous");
const selectPlanNext = document.querySelector(".select-plan-next");
const addOnsPrevious = document.querySelector(".add-ons-previous");
const addOnsNext = document.querySelector(".add-ons-next");
const summaryPrevious = document.querySelector(".summary-previous");
...
// Buttons Mobile
const buttonsMobile = document.querySelector(".button-bg");
